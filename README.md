...
docker run --name pg-tasks -e POSTGRES_DB=tasks -e POSTGRES_PASSWORD=password 
-p 5433:5432 postgres:9.6
--------------------------------------------------------------------------------------------------
...
no Jenkns entrar em;
	...
	Secret(gerar no sonar http://localhost:9000/account/security/ -> escrever jenkins, copiar 
	e colar o token aqui)
	ID: SonarToken
